...
public class HealthReg : MonoBehaviour
{
    ...
    private IEnumerator SpawnObjectAtRandomIntervals()
    {
        while (true)
        {
            ...
            GameObject newObject = Instantiate(healthRegenObject, transform.position, Quaternion.identity);
    ...
    public void Spawn()
    {
        ...
        Instantiate(healthRegenObject, spawnLocation, Quaternion.identity);
    }
    ...
    //         Instantiate(healthRegenObject, transform.position, Quaternion.identity); // Instantiate the object at the spawner's position
    //     }
    // }
